            ...
            <section className='heroWrpper'>
                <div className="container">
                    <div className='firstBox mb-3'>
                        ...
                        <p className='contWrapperBox'>Effective Date: 04th February 2022 Thank you for showing interest in FinLogic Technologies. We value the trust you place in us. We are committed to protecting your privacy. This Privacy Policy explains how we collect, use and share your personal information. This Privacy Notice applies to your use of our website, and/or Services, and covers information collected in connection with your access to and use of our website and/or Services. Please read this Privacy Notice carefully. By continuing to interact with us, you are consenting to the practices described in this Privacy Policy. If you do not agree to the terms of this Privacy Policy, please do not use or access our Website and/ or Services.</p>
                    ...
                    <div className='secondbox mb-3'>
                        ...
                        <p className='innerWrapperbox'>We collect or receive information you provide when you apply, use or sign up for/on a FinLogic Technologies Web Development/Digital Marketing/E-commerce website/web design/Apps Development/Acquiring or other Services, go through our identity or account verification process, authenticate into your account, communicate with us, answer our surveys, upload content, or otherwise use the Services.</p>
