                ...
                <div className="row">
                    <div className="col-lg-6">
                        <div className={`${active === 1 ? 'activeBoxWrapper' : 'outerBoxWrapper'} mb-3`} onClick={() => setActive(1)}>
                            ...
                            <div>
                                <p className='subInnerCont'>Functions</p>
                                <p className='subInnerContent'>We function on different projects as a part to grow and evolve.</p>
                            </div>
                        </div>
                        <div className={`${active === 2 ? 'activeBoxWrapper' : 'outerBoxWrapper'} mb-3`} onClick={() => setActive(2)}>
                            ...
                            <div>
                                <p className='subInnerCont'>Strategies </p>
                                <p className='subInnerContent'>The strategies made for projects are different from each other to make it unique.</p>
                            </div>
                        </div>
                        <div className={`${active === 3 ? 'activeBoxWrapper' : 'outerBoxWrapper'} mb-4`} onClick={() => setActive(3)}>
                            <label className='outerwrapper'>
                            ...
                            <div>
                                <p className='subInnerCont'>Effectiveness</p>
                                <p className='subInnerContent'>We put our best foot forward in each project to delve more effectiveness to it.</p>
                            </div>
                        </div>
                    </div>
                    <div className="col-lg-6">
